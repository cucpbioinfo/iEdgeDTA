...
class CreateDatasetInfer(InMemoryDataset):
    def __init__(self, root='/', dataset='kiba', drugList=None, protkey=None, 
        ...
        super(CreateDatasetInfer, self).__init__(root, transform, pre_transform)
    ...
    def processed_paths(self, filenames="mol"):
        return os.path.join(os.path.join(self.root, self.processed_file_names(filenames)[0]))
